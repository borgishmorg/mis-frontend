...
@Component({
  selector: 'app-new-orthopedist-examination',
  templateUrl: './new-orthopedist-examination.component.html',
  styleUrls: ['./new-orthopedist-examination.component.css'],
})
export class NewOrthopedistExaminationComponent implements OnInit {
  examination?: OrthopedistExaminationPost;
  oldExamination?: OrthopedistExaminationPost;
      ...
      this.usersService
        ...
        .subscribe((patient) => {
          ...
          this.examination = {
            ...
            diagnosis: '',
            recomendations: '',
            type: ExaminationType.ORTHOPEDIST,
            asymmetry: '',
            foot_deformation: '',
            lower_limb_axis: '',
            lower_limb_joints_functions: '',
            neurovascular_disorders: '',
            spine_axis: '',
            upper_limb_axis: '',
            upper_limb_joints_functions: '',
            user_id: user_id,
